...
public class AdapterItemOffice extends BaseAdapter {

    protected Activity activity;
    protected ArrayList<Category> items;

    public AdapterItemOffice (Activity activity, ArrayList<Category> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = inf.inflate(R.layout.fragment_office, null);
        }
